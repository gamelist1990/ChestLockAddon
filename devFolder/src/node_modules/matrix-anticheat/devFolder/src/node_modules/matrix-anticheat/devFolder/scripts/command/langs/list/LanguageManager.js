...
let playerLangList = {};
// 言語設定を保存する関数
export function savePlayerLanguage(player, language) {
...
export function loadPlayerLanguages() {
    ...
    if (storedLangList) {
        playerLangList = JSON.parse(storedLangList); // JSON 文字列をパース
    }
}
export function getAvailableLanguages() {
    return availableLanguages;
}
export function showPlayerLanguage(player) {
...
export function translate(player, key, params, targetPlayer) {
