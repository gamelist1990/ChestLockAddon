export const translations = {
  ...
  "ChangeName": {
    msgid: "Item Change Name",
    msgstr: ""
  },
  "ClearLore": {
    msgid: "Item Clear Lore",
    msgstr: ""
  },
  "Newlore": {
  ...
  "Usagelore": {
    msgid: "Usage: {prefix}lore -set <lore content> or {prefix}lore -remove <lore content> or {prefix}lore -rename <new name> or {prefix}lore -clearlore",
    msgstr: ""
  },
  "ADDLore": {
    msgid: "Added lore, please check",
    msgstr: ""
  },
  "TakeItem": {
    msgid: "Please take the item.",
    msgstr: ""
  },
  "LoreNotFound": {
    msgid: "Lore not found",
    msgstr: ""
  },
  "RemoveLore": {
    msgid: "Lore has been deleted. Please check.",
    msgstr: ""
  },
  "ChangeNames": {
    msgid: "Renamed the item",
    msgstr: ""
  },
  "uilore": {
    msgid: "Custom Item Name/Lore",
    msgstr: ""
  },
  "FirstPointSet": {
  ...
  "desabledCom": {
    ...
    msgstr: "§cНезарегистрированная или отключенная команда"
  },
  "desableComSuggest": {
    msgid: "§6Invalid command. Is it possibly the {possibleCommands} command? If so, answer {prefix}yes",
    msgstr: "§6Неверная команда. Возможно, это команда {possibleCommands}? Если да, ответьте {prefix}да"
  },
  "AllowTagCom": {
    msgid: "§cOnly players with an authorized tag can use it",
    msgstr: "§cТолько игроки с авторизованным тегом могут использовать это"
  },
  "invalidCom": {
    msgid: "§6invalid command. Please make sure it is correct Commands used:{commandName}",
    msgstr: "§6Неверная команда. Пожалуйста, убедитесь, что она правильная. Использованные команды: {commandName}"
  },
  "Developer commands": {
  ...
  "lang_invalid": {
    ...
    msgstr: "§cНеверное использование команды. Используйте lang list или lang change <языковой_код>"
  },
  "chest_command": {
    msgid: "Chest Command",
  ...
  "chestProtectRemove": {
    ...
    msgstr: "§a Защита сундука снята"
  },
  "AlreadyProChest": {
    msgid: "§a This chest is already protected",
    msgstr: "§a Этот сундук уже защищен"
  },
  "chest_lookstate": {
  ...
  "NotFoundM": {
    msgid: "§c No members",
    msgstr: "§c Нет участников"
  },
  "ExplosionWarning": {
    msgid: "§c Can you please not blow that up?",
    msgstr: "§c Не могли бы вы не взрывать это?"
  },
  "cannotPlaceItem": {
    msgid: "§c It is forbidden to place pistons in this area",
    msgstr: "§c Запрещено размещать поршни в этой области"
  },
};
