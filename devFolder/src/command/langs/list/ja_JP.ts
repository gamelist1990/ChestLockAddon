export const translations = {
  ...
  "hub_docs": {
    msgid: "Hub Command",
    msgstr: "ハブに移動コマンド！(初期リス)"
  },
  "tag_docs": {
    msgid: "tag Command ",
    msgstr: "タグコマンド！！ (名前のところに色々付きます)"
  },
  "invsee_docs": {
  ...
  "ban_docs": {
    ...
    msgstr: "危険なプレイヤーのaccessを禁止します"
  },
  "unban_docs": {
    msgid: "Unbans a player from the server",
    msgstr: "BANしたプレイヤーのBANを解除します"
  },
  "banlist_docs": {
    msgid: "Shows the list of banned players  ",
    msgstr: "現在BANされているプレイヤーを表示"
  },
  "lockdown_docs": {
  ...
  "ui.sendtempkickUser": {
    ...
    msgstr: "§l§bキックしたいユーザーを選択"
  },
  "ui.warnPlayer": {
    msgid: "§l§3Select Warn To Player",
    msgstr: "§l§3警告を送りたいプレイヤーを選択"
  },
  "ui.kick": {
    msgid: "§l§0Kick user",
    msgstr: "§l§0ユーザーをキック"
  ...
  "ui.unbanPlayer": {
    ...
    msgstr: "§0 プレイヤーのBanを解除"
  },
  "ui.BanPlayerSelect": {
    msgid: "§2Select The Ban Player",
    msgstr: "§2 Banするプレイヤーを選択してください"
  },
  "ui.BanDurationTitle": {
