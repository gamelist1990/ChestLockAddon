export const translations = {
  ...
  "lang_invalid": {
    ...
    msgstr: "§c잘못된 명령어 사용법입니다. lang list 또는 lang change <언어 코드>를 사용하세요"
  },
  "chest_command": {
    msgid: "Chest Command",
    msgstr: "상자 명령어"
  ...
  "chestProtectRemove": {
    ...
    msgstr: "§a 상자 보호가 제거되었습니다"
  },
  "AlreadyProChest": {
    msgid: "§a This chest is already protected",
    msgstr: "§a 이 상자는 이미 보호되고 있습니다"
  },
  "chest_lookstate": {
  ...
  "cannotPlaceItem": {
    ...
    msgstr: "§c 이 지역에 피스톤을 설치할 수 없습니다"
  },
};
