export const translations = {
  ...
  "command.report.newReport": {
    ...
    msgstr: "§f>>§a§l来自 {reporter} 关于 {reportedPlayer} 的新举报"
  },
  ...
  "command.ui.reportTitle": {
    ...
    msgstr: "§l§0{selectedReporter} 有举报"
  },
  ...
  "ui.TpaRequesMenu": {
    ...
    msgstr: "§2 欢迎来到 TPA 菜单！当前请求：{requestList} 人"
  },
  "ui.SendTpa": {
  ...
  "ui.SelectTpaRequest": {
    ...
    msgstr: "§2你收到了一个 TPA 请求。请选择您要接受的玩家。"
  },
  "ui.SendTpaSelect": {
  ...
  "command.help.helpPage": {
    ...
    msgstr: "§2--- 显示第 {pageNumber} 页（共 {totalPages} 页）({PREFIX}help <页码: 整数>) ---\n"
  },
  ...
  "command.about.about": {
    ...
    msgstr: "§a== 关于 ChestLockAddon ==\n\nChestLockAddon 是一个适用于 Minecraft 1.21.40 版本的实用插件，提供箱子保护等功能。\n\n§b== 主要功能 ==\n• 箱子保护：保护你的箱子不受其他玩家的侵害。\n• 多语言支持：使用 lang 命令更改语言设置。\n• 传送请求：使用 tpa 命令向其他玩家发送传送请求。\n• 以及更多：未来将添加更多有用的命令。\n\n§b== 链接 ==\n• GitHub: https://github.com/gamelist1990/ChestLockAddon\n• YouTube: https://www.youtube.com/@PEXkoukunn\n• Discord: https://discord.gg/GJyqBm7Pyd\n\n§c== 注意事项 ==\n此插件正在开发中，可能包含意外的错误。如果发现任何错误，请在 GitHub 或 Discord 上报告。\n\n§a== 开发者的留言 ==\n我们欢迎您的反馈，以便使 ChestLockAddon 成为更好的插件。"
  },
  "server.ServerVersion": {
    msgid: "§bThis ChestLockAddon is running version {version}",
    msgstr: "§b此 ChestLockAddon 正在运行 {version} 版本"
  },
  "server.Invalid": {
  ...
  "command.lore.UsageLore": {
    ...
    msgstr: "§3用法：{prefix}lore -set \"<描述内容>\" 或 {prefix}lore -remove \"<描述内容>\" 或 {prefix}lore -rename \"<新名称>\" 或 {prefix}lore -command.ClearLore"
  },
  ...
  "command.edit.RangeSet": {
    ...
    msgstr: "§f>>§a 使用指定方块 ({blockId}) 设置范围。"
  },
  ...
  "command.warp.UsageGate": {
    ...
    msgstr: "§c 无效的子命令用法: {prefix}warpgate <-create/delete/list> [名称] |\n§c 仅创建命令：-create [名称] [x,y,z]"
  },
  "command.warp.TPGATE": {
    msgid: "§a Teleported to warp gate: {gate}.",
    msgstr: "§a 已传送到传送门：{gate}。"
  },
  ...
  "command.join.UsageJoin": {
    ...
    msgstr: "§c 用法：join <-true/-false/-settings>"
  },
